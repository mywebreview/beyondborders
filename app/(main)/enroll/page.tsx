...
// Define proper types for localStorage data
...
export default function Enroll() {
  ...
  const submitApplication = async (completeData: CompleteApplication) => {
    ...
    try {
      ...
      // Go back to documents step if submission fails
      setCurrentStep(9)
    } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <section className="py-8 lg:py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Progress Section - Updated for Mobile Responsiveness */}
          {currentStep < 10 && (
            <div className="mb-8 lg:mb-12">
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 sm:p-6 lg:p-8">
                ...
                <div className="relative">
                  ...
                  {/* Mobile Progress Steps - Compact Version */}
                  ...
                  {/* Desktop Progress Steps - Enhanced */}
                ...
                <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    {/* Progress Percentage - Hidden on mobile, shown on desktop */}
